...
*/
	...
	if ~inlist(country_name,"Montenegro2018","Thailand2019","Turkmenistan2019","Serbia2019","NorthMacedonia2018") {	
...
* c_diarrhea_hmf:  Child under 5 with diarrhea in last 2 weeks received	Government recommended homemade fluid (Coconut water or rice water with salt)		
		...
		if ~inlist(country_name,"KyrgyzRepublic2018","Guinea-Bissau2018","Tonga2019","SaoTomeAndPrincipe2019") {		
