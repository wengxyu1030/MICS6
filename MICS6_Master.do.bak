...
*******************************	
	...
	capture confirm file "${SOURCE}/MICS6-`name'/MICS6-`name'tn.dta"
	if !_rc{
	
	use "${SOURCE}/MICS6-`name'/MICS6-`name'tn.dta", clear	
...
***********************************
	...
	capture confirm file "${SOURCE}/MICS6-`name'/MICS6-`name'bh.dta"
	if !_rc{					
		
	use "${SOURCE}/MICS6-`name'/MICS6-`name'bh.dta", clear
